...
const FrameComponent1 = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={Handle}
        className={` cursor-pointer w-[12.188rem] m-0 top-0 left-[25.5rem] 2xl:w-[12.188rem] 2xl:left-[25.5rem] md:w-[9.188rem] md:left-[20.5rem] text-custom-gray leading-[1.008rem] font-bold text-[1.2rem] md:text-[0.9rem] 2xl:text-[1.2rem] rounded-2xl
